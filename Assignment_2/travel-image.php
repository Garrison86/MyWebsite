...
<div class="container">  <!-- start main content container -->
   <div class="row">  <!-- start main content row -->
      ...
      <div class="col-md-9">  <!-- start main content column -->
         <ol class="breadcrumb">
           <li><a href="UnderConstruction.php">Home</a></li>
           <li><a href="travel.php">Favorites</a></li>
           <li class="active"><?php $images[$_GET['id']]['title'] ?></li>
         </ol> 

         <?php echo '<h1>'.$images[$_GET['id']]['title'].'</h1>';?>
   
         <div class="row">
            <div class="col-md-8">
               <?php 

            echo '<img src="images/travel/medium/'.$images[$_GET['id']]['path'].'" class="img-responsive center-block" title="'.$images[$_GET['id']]['title'].'">';
               ?>
            ...
            <div class="col-md-4">
               <div class="panel panel-primary">
                  <div class="panel-body">
                     <?php echo '<p>By '.$images[$_GET['id']]['user'].'</p>'; ?>
                     <?php echo '<p>Taken in '.$images[$_GET['id']]['country'].'</p>'; ?>
                     <?php echo '<p>'.$images[$_GET['id']]['description'].'</p>'; ?>
                   </div>
               </div>
            </div>
         </div>
