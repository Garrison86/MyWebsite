...
<ol class="breadcrumb">
   <li><a href="travel.php">Home</a></li>
           <li><a href="UnderConstruction.php">Browse</a></li>
         ...
         <div class="well">
            <div class="row">
               ...
               foreach ($images as $key){ 
                     echo '<a href="travel-image.php?id='.$key['id'].'";>';
                     echo '<img  
                     id="'.$key['id'].'"; 
                     src="images/travel/square/'.$key['path'].'";
                     title="'.$key['title'].'"; 
                     description="'.$key['description'].'"; 
                     country="'.$key['country'].'"; 
                     user="'.$key['user'].'"; 
                     style="width:200px; height:200px; margin: 20px;"></a>';
                  } 
               echo '</div>';   
               ?>
            </div>
